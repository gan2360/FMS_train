...
from rawModel.lib.yolov3.util import *
from rawModel.lib.yolov3.darknet import Darknet
from rawModel.lib.yolov3 import preprocess
...
class YoloModelPrediction:
    def __init__(self):
        self.model = load_model()
    
    def yolo_human_det(self, img, reso=416, confidence=0.30):
        args = arg_parse()
        # args.reso = reso
        inp_dim = reso
        num_classes = 80
        ...
        CUDA = torch.cuda.is_available()
        # if model is None:
        #     model = self.load_model(args, CUDA, inp_dim)
